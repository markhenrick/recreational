...
public class Day05 {
	...
	static long applyFns(List<List<FunctionPiece>> fns, long input) {
		var current = input;
		for (val fn : fns) {
	...
	static long applyFn(List<FunctionPiece> fn, long input) {
	...
	static Pair<List<Long>, List<List<FunctionPiece>>> parseInputP1(String input) {
	...
	static Pair<List<SeedRange>, List<List<FunctionPiece>>> parseInputP2(String input) {
	...
	static List<FunctionPiece> parseFunction(String input) {
