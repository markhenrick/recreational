...
* **Bit set** [Chosen] - the logical conclusion of the dynamic array with full population. 1010 is a rather small number, requiring just 10 bits, so this solution is quite feasible even on constrained hardware